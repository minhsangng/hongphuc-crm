...
const classes = [
  { img: "classes1.jpg", date: "16/01/2024", location: "Lộ Vàm, Chợ Gạo, Đồng Tháp", title: "Buổi Dã Ngoại Cuối Năm Học" },
  { img: "classes2.png", date: "16/01/2024", location: "Lộ Vàm, Chợ Gạo, Đồng Tháp", title: "Tuần Lễ Khám Phá Vườn Xuân" },
  { img: "classes3.jpg", date: "16/01/2024", location: "Lộ Vàm, Chợ Gạo, Đồng Tháp", title: "Ngày Hội Sắc Màu Sáng Tạo" },
];
    ...
    <section className="classes-section section-padding fix">
      ...
      <div className="w-[90%] mx-auto">
        <div className="section-title text-center custom-padding-top">
          <span className="sub-title tittle-bg-2">Hoạt Động Của Trường</span>
          <h2 className="text-white">Nuôi Dưỡng &amp; <span>Tâm Hồn Trẻ Thơ</span> – Bằng <br /> Yêu Thương &amp; Tri Thức</h2>
        </div>
              ...
              <div className="classes-box-item">
                ...
                <div className="classes-content">
                  ...
                  <div className="classes-rate">
                    ...
                    <div className="rate">
                      <p className="!text-xs">(10 đánh giá)</p>
                      <ul>
                        {Array.from({ length: 5 }).map((_, i) => (<li key={i}><Star color="yellow" className="group-hover:stroke-white"/></li>))}
                      </ul>
                    </div>
                  </div>
                </div>
